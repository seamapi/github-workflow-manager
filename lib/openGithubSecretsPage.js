...
const openGithubSecretsPage = ({ userRepoDir }) => {
  ...
  const secretsPageUrl = `https://github.com/${repo}/settings/secrets/new`
  console.log(`\n\tOpening... "${secretsPageUrl}"\n`)
  open(secretsPageUrl)
}

module.exports = openGithubSecretsPage
